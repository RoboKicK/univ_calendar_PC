//class FindGanji{
  ...
  LunarToSolar(int _targetYear, int _targetMonth, int _targetDay, bool isLeap){
    ...
    while(true){
      if(solMonth == 1 && solYear % 4 == 0){
        ...
        monthNday = listSolNday[solMonth];
      }
      if(days > monthNday){
        days = days - monthNday;
        solMonth++;
  ...
  FindGanjiData(){
    ...
    listLunNday.add([30, 0, 29, 0, 30, 0, 29, 0, 29, 0, 30, 29, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 30, 0]); //1911년
    ...
    listLunNday.add([30, 0, 29, 0, 30, 0, 29, 0, 29, 0, 30, 0, 29, 0, 29, 0, 30, 0, 29, 0, 30, 0, 30, 0]);  //1921년
    ...
    listLunNday.add([30, 0, 30, 0, 30, 0, 29, 0, 29, 0, 30, 0, 29, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0]);  //1931년
    ...
    listLunNday.add([30, 0, 30, 0, 29, 0, 30, 0, 30, 0, 29, 30, 29, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0]); //1941년
    ...
    listLunNday.add([30, 0, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0]);  //1951년
    ...
    listLunNday.add([30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0]);  //1961년
    ...
    listLunNday.add([29, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0]);
    listLunNday.add([30, 0, 29, 0, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0]);
    listLunNday.add([29, 0, 30, 0, 29, 0, 29, 0, 30, 29, 30, 0, 29, 0, 30, 0, 30, 0, 30, 0, 29, 0, 30, 0]); //1971년
    listLunNday.add([29, 0, 30, 0, 29, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 30, 0, 30, 0, 29, 0]);
    ...
    listLunNday.add([30, 0, 29, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 30, 0]);
    listLunNday.add([29, 0, 30, 0, 29, 0, 29, 0, 30, 0, 29, 0, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 30, 0]);  //1981년
    ...
    listLunNday.add([29, 0, 30, 0, 29, 0, 29, 0, 30, 0, 29, 0, 29, 0, 30, 0, 29, 0, 30, 0, 30, 0, 30, 0]);  //1991년
    ...
    listLunNday.add([30, 0, 30, 0, 30, 0, 29, 29, 30, 0, 29, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0]); //2001년
    listLunNday.add([30, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0]);
    ...
    listLunNday.add([30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0]);
    listLunNday.add([30, 0, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 29, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0]);  //2011년
    ...
    listLunNday.add([29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0]);  //2021년
    ...
    listLunNday.add([30, 0, 29, 0, 30, 29, 30, 0, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0]); //2031년
    ...
    listLunNday.add([30, 0, 29, 0, 29, 0, 30, 0, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0]);  //2041년
    ...
    listLunNday.add([29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 29, 0, 29, 0]);
    listLunNday.add([30, 0, 29, 0, 30, 0, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 30, 0, 29, 0, 30, 0, 29, 0]);  //2049년
