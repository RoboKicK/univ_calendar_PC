...
class Diarysavelist extends StatefulWidget {
  const Diarysavelist({super.key, required this.widgetWidth, required this.SetSideOptionWidget, required this.CloseOption});
                    ...
                    return Container(
                      ...
                      child: ElevatedButton(
                        onPressed: (){
                          ...
                          setState(() {
                            widget.SetSideOptionWidget(diaryWriting.DiaryWriting(listTodayPalja: listTodayPalja, userIlganNum: personalDataManager.mapUserData['listPaljaData'][4], userYeonjiNum: personalDataManager.mapUserData['listPaljaData'][1], diaryYear: (saveDataManager.mapDiary[i]['dayData'] / 10000).floor(), diaryMonth: ((saveDataManager.mapDiary[i]['dayData'] % 10000) / 100).floor(),
                              diaryDay: saveDataManager.mapDiary[i]['dayData'] % 100, dayString: saveDataManager.mapDiary[i]['memo'].substring(0,1), isWriting: 0, CloseOption: widget.CloseOption,), isCompulsionOn : true);
                          });
                        },
